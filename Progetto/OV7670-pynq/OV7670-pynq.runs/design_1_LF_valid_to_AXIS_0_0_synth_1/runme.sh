...
HD_PWD='/home/adrian/github_repos/OV7670-PynqZ2/Progetto/OV7670-pynq/OV7670-pynq.runs/design_1_LF_valid_to_AXIS_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_LF_valid_to_AXIS_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_LF_valid_to_AXIS_0_0.tcl
